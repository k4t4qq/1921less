...
if choicelibrary == "urllib":
    ...
    while True:
        ...
        if choicemethod == "__builtins__":
            ...
            print("This method in library urllib doesn't exist")
else:
    print("This library can't introspecting")
...
if choicelibrary == "datetime":
    ...
    while True:
        ...
        if choicemethod == "MAXYEAR":
        ...
        elif choicemethod == "tzinfo":
            print("\nMethod tzinfo is class?", inspect.isclass(datetime.tzinfo))
            print("\nMethod tzinfo is callable?", callable(datetime.tzinfo))
            for method in dir(datetime.tzinfo):
                print("\n", method)
            ...
            print("This method in library datetime doesn't exist")
else:
    print("This library can't introspecting")
#____________________________________________________________________
